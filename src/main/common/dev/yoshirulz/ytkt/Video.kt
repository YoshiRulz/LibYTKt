...
data class Video constructor(
	...
	@EntryPoint
	val embedURI: URI get() = id.embedURI
	...
	@EntryPoint
	val linkedSameChannelSimilarPlaylist: PlaylistID get() = id.linkedSameChannelSimilarPlaylist

	/** The autogenerated "YouTube Mix" playlist, populated with similar videos. */
	@EntryPoint
	val linkedSimilarPlaylist: PlaylistID get() = id.linkedSimilarPlaylist
	...
	@EntryPoint
	val shortURI: URI get() = id.shortURI
